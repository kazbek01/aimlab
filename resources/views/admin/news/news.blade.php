        ...
        <div class="row page-titles">
            <div class="col-md-8 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0 d-inline-block menu-tab">
                    <a href="/admin/news" class="@if(!isset($request->active) || $request->active == '1') active-page @endif">Опубликованные проекты</a>
                </h3>
                <h3 class="text-themecolor m-b-0 m-t-0 d-inline-block menu-tab second-tab" >
                    <a href="/admin/news?active=0" class="@if($request->active == '0') active-page @endif">Неопубликованные</a>
                </h3>
                ...
                <div class="box-body">
                    <table id="news_datatable" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <form>
                                     <input value="{{$request->news_title}}" type="text" class="form-control" name="news_title" placeholder="">
                                     <input type="hidden" value="@if(!isset($request->active)){{'1'}}@else{{$request->active}}@endif" name="active"/>
                                </form>
                            </td>
                            <td>
                                <form>
                                    <input value="{{$request->news_title}}" type="hidden" class="form-control" name="news_title" placeholder="">
                                    <input type="hidden" value="@if(!isset($request->active)){{'1'}}@else{{$request->active}}@endif" name="active"/>
                                </form>
                            </td>
                            <td>
