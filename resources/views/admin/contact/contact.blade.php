    ...
    <div class="container-fluid">
        <div class="row page-titles">
            ...
            <div class="col-md-4 col-4 align-self-center text-right">
                <a href="/admin/contact/create" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"> Добавить</a>
            </div>
        </div>
                    ...
                    <table id="contact_datatable" class="table table-bordered table-striped">
                        ...
                        @foreach($row as $key => $val)
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <li>Телефон: {{ $val['phone']}}</li>
                                        <li>Whatsapp: {{ $val['whatsapp']}}</li>
                                ...
                                <td style="text-align: center">
                                    <a href="/admin/contact/{{ $val->contact_id }}/edit">
